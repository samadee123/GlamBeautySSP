...
<section class="hero">
    <div class="hero__slider owl-carousel">
        ...
        <div class="hero__items set-bg" data-setbg="img/hero/banner-bg-fotor.png">
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-7 col-md-8">
                        <div class="hero__text">
                            <h6>Perfume Collection</h6>
                            <h2>Scented Stories, Captivating Memories</h2>
                            <p>Experience the Essence of Elegance and Luxury with Our Exquisite Perfume Collection.</p>
